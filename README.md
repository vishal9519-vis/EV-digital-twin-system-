...
│
├── data/
│   └── battery_telemetry.csv        # Generated by setup.py
│
└── models/
    ├── range_model.pkl              # Trained RandomForest (range prediction)
    ├── thermal_model.pkl            # Trained GradientBoosting (temp forecast)
    └── health_model.pkl             # Trained RandomForest (health classification)
```
